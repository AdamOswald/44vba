...
static const u8 BBDefaultData[105] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x10 - 0x1F
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x20 - 0x2F
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x30 - 0x3F
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x40 - 0x4F
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,            // 0x50 - 0x5F
    0x00, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00 // 0x60 - 0x68
};

static const bool BBIsDataWritable[105] = {
    false, true,  true,  true, true,  true,  true,  true,  true,
    true,  true,  true,  true, false, false, false, // 0x00 - 0x0F
    false, false, false, true, true,  true,  false, false, false,
    false, false, true,  true, true,  true,  true, // 0x10 - 0x1F
    true,  true,  true,  true, true,  true,  true,  false, true,
    true,  true,  true,  true, true,  true,  true, // 0x20 - 0x2F
    true,  true,  true,  true, true,  true,  true,  true,  true,
    true,  true,  true,  true, true,  true,  true, // 0x30 - 0x3F
    true,  true,  true,  true, true,  true,  true,  true,  true,
    true,  true,  true,  true, false, true,  true, // 0x40 - 0x4F
    true,  true,  true,  true, true,  true,  true,  true,  true,
    true,  true,  true,  true, false, false, false,             // 0x50 - 0x5F
    false, false, true,  true, false, true,  false, true,  true // 0x60 - 0x68
};

static const u16 RFPinsLUT[10] = {0x04, 0x84, 0, 0x46, 0,
                                  0x84, 0x87, 0, 0x46, 0x04};
static const WifiLLCSNAPHeader DefaultSNAPHeader = {
    0xAA, 0xAA, 0x03, {0x00, 0x00, 0x00}, 0x0800};
...
const u8 FW_BBInit[105] = {
    0x6D, 0x9E, 0x40, 0x05, 0x1B, 0x6C, 0x48, 0x80, 0x38, 0x00, 0x35, 0x07,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xb0, 0x00, 0x04, 0x01,
    0xd8, 0xff, 0xff, 0xc7, 0xbb, 0x01, 0xb6, 0x7f, 0x5a, 0x01, 0x3f, 0x01,
    0x3f, 0x36, 0x36, 0x00, 0x78, 0x28, 0x55, 0x08, 0x28, 0x16, 0x00, 0x01,
    0x0e, 0x20, 0x02, 0x98, 0x98, 0x1f, 0x0a, 0x08, 0x04, 0x01, 0x00, 0x00,
    0x00, 0xff, 0xff, 0xfe, 0xfe, 0xfe, 0xfe, 0xfc, 0xfa, 0xfa, 0xf8, 0xf8,
    0xf6, 0xa5, 0x12, 0x14, 0x12, 0x41, 0x23, 0x03, 0x04, 0x70, 0x35, 0x0E,
    0x16, 0x16, 0x00, 0x00, 0x06, 0x01, 0xff, 0xfe, 0xff, 0xff, 0x00, 0x0e,
    0x13, 0x00, 0x00, 0x28, 0x1c};
const u8 FW_RFInit[36] = {0x07, 0xC0, 0x00, 0x03, 0x9C, 0x12, 0x28, 0x17, 0x14,
                          0xba, 0xe8, 0x1a, 0x6f, 0x45, 0x1d, 0xfa, 0xff, 0x23,
                          0x30, 0x1d, 0x24, 0x01, 0x00, 0x28, 0x00, 0x00, 0x2c,
                          0x03, 0x9c, 0x06, 0x22, 0x00, 0x08, 0x6f, 0xff, 0x0d};
const u8 FW_RFChannel[6 * 14] = {
    0x28, 0x17, 0x14,                   /* Channel 1 */
    0xba, 0xe8, 0x1a, 0x37, 0x17, 0x14, /* Channel 2 */
    0x46, 0x17, 0x19, 0x45, 0x17, 0x14, /* Channel 3 */
    0xd1, 0x45, 0x1b, 0x54, 0x17, 0x14, /* Channel 4 */
    0x5d, 0x74, 0x19, 0x62, 0x17, 0x14, /* Channel 5 */
    0xe9, 0xa2, 0x1b, 0x71, 0x17, 0x14, /* Channel 6 */
    0x74, 0xd1, 0x19, 0x80, 0x17, 0x14, /* Channel 7 */
    0x00, 0x00, 0x18, 0x8e, 0x17, 0x14, /* Channel 8 */
    0x8c, 0x2e, 0x1a, 0x9d, 0x17, 0x14, /* Channel 9 */
    0x17, 0x5d, 0x18, 0xab, 0x17, 0x14, /* Channel 10 */
    0xa3, 0x8b, 0x1a, 0xba, 0x17, 0x14, /* Channel 11 */
    0x2f, 0xba, 0x18, 0xc8, 0x17, 0x14, /* Channel 12 */
    0xba, 0xe8, 0x1a, 0xd7, 0x17, 0x14, /* Channel 13 */
    0x46, 0x17, 0x19, 0xfa, 0x17, 0x14, /* Channel 14 */
    0x2f, 0xba, 0x18};
const u8 FW_BBChannel[14] = {
    0xb3, 0xb3, 0xb3, 0xb3, 0xb3, /* channel  1- 6 */
...
INLINE bool WIFI_IsLLCSNAPHeader(const u8 *snapHeader) {
  return ((*(u16 *)&snapHeader[0] == *(u16 *)&DefaultSNAPHeader.dsap) &&
          (*(u32 *)&snapHeader[2] == *(u32 *)&DefaultSNAPHeader.control));
}
  ...
  for (int i = 0; i < 0x100; i++) {
    ...
    for (int j = 0; j < 8; j++)
      WIFI_CRC32Table[i] = (WIFI_CRC32Table[i] << 1) ^
                           (WIFI_CRC32Table[i] & (1 << 31) ? polynomial : 0);
...
/*******************************************************************************
        ...
        wifimac IO: a lot of the wifi regs are action registers, that are
 mirrored without action, so the default IO via MMU.c does not seem to be very
 suitable
...
static void WIFI_TXStart(const WifiTXLocIndex txSlotIndex,
...
RXPacketHeader WIFI_GenerateRXHeader(const u8 *packetIEEE80211HeaderPtr,
                                     const u16 timeStamp, const bool isTXRate20,
                                     const u16 emuPacketSize) {
  ...
  case WifiFrameType_Management: {
    const WifiMgmtFrameHeader &IEEE80211Header =
        (WifiMgmtFrameHeader &)packetIEEE80211HeaderPtr[0];
    rxHeader.rxFlags.MatchingBSSID =
        (WIFI_compareMAC(IEEE80211Header.BSSID, io.BSSID)) ? 1 : 0;
  ...
  case WifiFrameType_Control: {
    ...
    case WifiFrameControlSubtype_PSPoll: {
      const WifiCtlFrameHeaderPSPoll &IEEE80211Header =
          (WifiCtlFrameHeaderPSPoll &)packetIEEE80211HeaderPtr[0];
      rxHeader.rxFlags.MatchingBSSID =
          (WIFI_compareMAC(IEEE80211Header.BSSID, io.BSSID)) ? 1 : 0;
      break;
    }
    ...
    case WifiFrameControlSubtype_End: {
      const WifiCtlFrameHeaderEnd &IEEE80211Header =
          (WifiCtlFrameHeaderEnd &)packetIEEE80211HeaderPtr[0];
      rxHeader.rxFlags.MatchingBSSID =
          (WIFI_compareMAC(IEEE80211Header.BSSID, io.BSSID)) ? 1 : 0;
      break;
    }
    ...
    case WifiFrameControlSubtype_EndAck: {
      const WifiCtlFrameHeaderEndAck &IEEE80211Header =
          (WifiCtlFrameHeaderEndAck &)packetIEEE80211HeaderPtr[0];
      rxHeader.rxFlags.MatchingBSSID =
          (WIFI_compareMAC(IEEE80211Header.BSSID, io.BSSID)) ? 1 : 0;
      break;
    }
  ...
  case WifiFrameType_Data: {
    ...
    case WifiFCFromToState_STA2STA: {
      const WifiDataFrameHeaderSTA2STA &IEEE80211Header =
          (WifiDataFrameHeaderSTA2STA &)packetIEEE80211HeaderPtr[0];
      rxHeader.rxFlags.MatchingBSSID =
          (WIFI_compareMAC(IEEE80211Header.BSSID, io.BSSID)) ? 1 : 0;
      break;
    }
    ...
    case WifiFCFromToState_STA2DS: {
      const WifiDataFrameHeaderSTA2DS &IEEE80211Header =
          (WifiDataFrameHeaderSTA2DS &)packetIEEE80211HeaderPtr[0];
      rxHeader.rxFlags.MatchingBSSID =
          (WIFI_compareMAC(IEEE80211Header.BSSID, io.BSSID)) ? 1 : 0;
    ...
    case WifiFCFromToState_DS2STA: {
      const WifiDataFrameHeaderDS2STA &IEEE80211Header =
          (WifiDataFrameHeaderDS2STA &)packetIEEE80211HeaderPtr[0];
      rxHeader.rxFlags.MatchingBSSID =
          (WIFI_compareMAC(IEEE80211Header.BSSID, io.BSSID)) ? 1 : 0;
    ...
    case WifiFCFromToState_DS2DS: {
      // We shouldn't be receiving any DS-to-DS packets, but include this case
      // anyways to account for all possible code paths.
...
static void WIFI_TXStart(const WifiTXLocIndex txSlotIndex,
  ...
  WIFI_LOG(
      3, "TX slot %i trying to send a packet: TXCnt = %04X, TXBufLoc = %04X\n",
  ...
  if (txLocation.TransferRequest != 0) /* is slot enabled? */
  {
    ...
    if (byteAddress >
        (0x2000 - sizeof(TXPacketHeader) - sizeof(WifiFrameControl))) {
      WIFI_LOG(1,
               "TX slot %i trying to send a packet overflowing from the TX "
               "buffer (address %04X). Attempt ignored.\n",
               (int)txSlotIndex, (int)byteAddress);
      return;
    }

    TXPacketHeader &txHeader = (TXPacketHeader &)wifi.RAM[byteAddress];
    const WifiFrameControl &fc =
        (WifiFrameControl &)wifi.RAM[byteAddress + sizeof(TXPacketHeader)];
    ...
    // - It is possible for the frame body to be 0 bytes for certain frame
    // types/subtypes.
    // - The frame check sequence (FCS) is always 4 bytes.
    if (txHeader.length < 14) {
      WIFI_LOG(1,
               "TX slot %i trying to send a packet with length field set to "
               "zero. Attempt ignored.\n",
               (int)txSlotIndex);
      return;
    }
    ...
    if ((txSlotIndex == WifiTXLocIndex_BEACON) ||
        (txLocation.IEEESeqCtrl == 0)) {
      if (fc.Type == WifiFrameType_Management) {
        WifiMgmtFrameHeader &mgmtHeader =
            (WifiMgmtFrameHeader &)
                wifi.RAM[byteAddress + sizeof(TXPacketHeader)];
        mgmtHeader.seqCtl.SequenceNumber = io.TX_SEQNO.Number;
        mgmtHeader.seqCtl.FragmentNumber = 0;
      } else if (fc.Type == WifiFrameType_Data) {
        // The frame header may not necessarily be a STA-to-STA header, but all
        // of the data frame headers place the sequence number value at the same
        // location in memory, so we can just use the STA-to-STA header to
        // represent all of the data frame headers.
        WifiDataFrameHeaderSTA2STA &dataHeader =
    ...
    u32 crc32 = WIFI_calcCRC32(&wifi.RAM[byteAddress + sizeof(TXPacketHeader)],
                               txHeader.length - 4);
    *(u32 *)&wifi
         .RAM[byteAddress + sizeof(TXPacketHeader) + txHeader.length - 4] =
        crc32;

    WIFI_triggerIRQ(WifiIRQ07_TXStart);

    if ((txSlotIndex == WifiTXLocIndex_LOC1) ||
        (txSlotIndex == WifiTXLocIndex_LOC2) ||
        (txSlotIndex == WifiTXLocIndex_LOC3)) {
      TXPacketInfo &txPacketInfo =
          wifiHandler->GetPacketInfoAtSlot(txSlotIndex);
      txPacketInfo.emuPacketLength = txHeader.length;
      txPacketInfo.remainingBytes = txHeader.length + sizeof(TXPacketHeader);

      switch (txSlotIndex) {
      case WifiTXLocIndex_LOC1:
        io.TXBUSY.Loc1 = 1;
        break;
      // case WifiTXLocIndex_CMD: io.TXBUSY.Cmd = 1; break;
      case WifiTXLocIndex_LOC2:
        io.TXBUSY.Loc2 = 1;
        break;
      case WifiTXLocIndex_LOC3:
        io.TXBUSY.Loc3 = 1;
        break;
      ...
      } else if ((txSlotIndex == WifiTXLocIndex_LOC2) &&
      ...
      wifiHandler->CommSendPacket(
          txHeader, &wifi.RAM[byteAddress + sizeof(TXPacketHeader)]);
      ...
      // Set timestamp
      *(u64 *)&wifi.RAM[byteAddress + sizeof(TXPacketHeader) +
                        sizeof(WifiMgmtFrameHeader)] = io.US_COUNT;
...
void WIFI_write16(u32 address, u16 val) {
  ...
  case REG_WIFI_MODE: // 0x004
  {
    ...
    if ((io.MODE_RST.TXMasterEnable == 0) && (MODE_RST.TXMasterEnable != 0)) {
      ...
      // According to GBATEK, the following registers might be reset to some
      // unknown values.
      // io.INTERNAL_2A2					= ???;
    }
  ...
  case REG_WIFI_POWER_US: // 0x036
  {
    ...
    io.POWER_US.Disable =
        (wifiHandler->GetCurrentEmulationLevel() == WifiEmulationLevel_Off)
            ? 1
            : POWER_US.Disable;
  ...
  case REG_WIFI_POWERFORCE: // 0x040
  {
    ...
    if (io.POWERFORCE.ApplyNewPowerOffState != 0) {
      if ((io.POWERFORCE.NewPowerOffState != 0) &&
          (io.POWERSTATE.IsPowerOff == 0)) {
        // Immediate action
        io.INTERNAL_034 = 0x0002;
        ...
        io.POWERSTATE.WillPowerOn = 0;
        io.POWERSTATE.IsPowerOff = 1;
      } else if ((io.POWERFORCE.NewPowerOffState == 0) &&
                 (io.POWERSTATE.IsPowerOff != 0)) {
        // Delayed action
  ...
  {
    /* set value into the circ buffer, and move cursor to the next hword on
     * action */
  ...
  case REG_WIFI_TXLOCBEACON: // 0x080
  {
    ...
    if (io.TXBUF_BEACON.TransferRequest != 0) {
      WIFI_LOG(3,
               "Beacon transmission enabled to send the packet at %08X every "
               "%i milliseconds.\n",
               0x04804000 + (io.TXBUF_BEACON.HalfwordAddress << 1),
               io.BEACONINT.Interval);
    }
    break;
  }
  ...
  case REG_WIFI_BBCNT: // 0x158
  {
    ...
    if (io.BB_CNT.Direction == 5) // Perform a write
    {
      ...
      if (io.BB_CNT.Index > 0x68) {
        WIFI_LOG(2,
                 "Writing value of %02Xh to BB_CNT.Index %02Xh, BB_CNT.Index "
                 "should be 00h-68h\n",
  ...
  case REG_WIFI_RFDATA2: // 0x17C
  {
    ...
    if (io.RF_DATA2.Type2.ReadCommand == 0) // Perform a write
    {
      ...
      case REG_RF2958_RFPLL3: {
        ...
        channelFreqN = (u32)rf.RFPLL3.NUM2 | ((u32)rf.RFPLL2.NUM2 << 18) |
                       ((u32)rf.RFPLL2.N2 << 24);
...
u16 WIFI_read16(u32 address) {
  ...
  case REG_WIFI_RANDOM: // 0x044
  {
    ...
    io.RANDOM.Random =
        (io.RANDOM.Random & 1) ^
        (((io.RANDOM.Random << 1) & 0x7FE) | ((io.RANDOM.Random >> 10) & 0x1));
    return returnValue;
  }
  ...
  case REG_WIFI_CIRCBUFWRITE: // 0x070 - mirrored read of 0x060
  {
    if (action) {
      ...
      } else if (io.RXBUF_RD_ADDR.HalfwordAddress ==
                 io.RXBUF_GAP.HalfwordAddress) {
        io.RXBUF_RD_ADDR.HalfwordAddress += io.RXBUF_GAPDISP.HalfwordOffset;

        if (io.RXBUF_RD_ADDR.ByteAddress >= io.RXBUF_END) {
          io.RXBUF_RD_ADDR.ByteAddress =
              io.RXBUF_RD_ADDR.ByteAddress + io.RXBUF_BEGIN - io.RXBUF_END;
        }
      }

      io.RXBUF_RD_DATA =
          *(u16 *)&wifi.RAM[io.RXBUF_RD_ADDR.HalfwordAddress << 1];
  ...
  // TODO: We return the default value for the original NDS. However, the
  // default value is different for NDS Lite.
...
static void SoftAP_RXPacketGet_Callback(u_char *userData,
                                        const pcap_pkthdr *pktHeader,
...
void *DummyPCapInterface::open(const char *source, int snaplen, int flags,
                               int readtimeout, char *errbuf) {
  this->__CopyErrorString(errbuf);
  return NULL;
}
...
int DummyPCapInterface::dispatch(void *dev, int num, void *callback,
                                 void *userdata) {
  return -1;
}
...
bool AdhocCommInterface::Start(WifiHandler *currentWifiHandler) {
  ...
  // This enables us to communicate with another DeSmuME instance running on the
  // same computer.
  result = setsockopt(thisSocket, SOL_SOCKET, SO_REUSEADDR,
                      (const char *)&socketOptValueTrue, sizeof(int));
  if (result < 0) {
  ...
  result = setsockopt(thisSocket, SOL_SOCKET, SO_REUSEPORT,
                      (const char *)&socketOptValueTrue, sizeof(int));
  if (result < 0) {
    closesocket(thisSocket);
    thisSocket = INVALID_SOCKET;
  ...
  *(u16 *)&saddr.sa_data[0] = htons(BASEPORT);
  ...
  result = setsockopt(thisSocket, SOL_SOCKET, SO_BROADCAST,
                      (const char *)&socketOptValueTrue, sizeof(int));
  if (result < 0) {
    closesocket(thisSocket);
    thisSocket = INVALID_SOCKET;
...
size_t AdhocCommInterface::TXPacketSend(u8 *txTargetBuffer, size_t txLength) {
  ...
  txPacketSize = sendto(thisSocket, (const char *)txTargetBuffer, txLength, 0,
                        &thisSendAddr, sizeof(sockaddr_t));
  WIFI_LOG(4, "Ad-hoc: sent %i/%i bytes of packet, frame control: %04X\n",
           (int)txPacketSize, (int)txLength,
           *(u16 *)(txTargetBuffer + sizeof(DesmumeFrameHeader)));
...
int AdhocCommInterface::_RXPacketGetFromSocket(RXRawPacketData &rawPacket) {
  ...
  if (select(thisSocket + 1, &fd, NULL, NULL, &tv)) {
    ...
    rxPacketSizeInt =
        recvfrom(thisSocket, (char *)targetPacket,
                 WIFI_WORKING_PACKET_BUFFER_SIZE, 0, &fromAddr, &fromLen);
    ...
    // 10 bytes - The smallest possible IEEE 802.11 frame header size
    // (WifiCtlFrameHeaderCTS/WifiCtlFrameHeaderACK) 4 bytes - Size of the FCS
    // at the end of every IEEE 802.11 frame
...
void AdhocCommInterface::RXPacketGet() {
  ...
  if ((thisSocket < 0) || (this->_rawPacket == NULL) ||
      (this->_wifiHandler == NULL)) {
    return;
  }
...
SoftAPCommInterface::~SoftAPCommInterface() { this->Stop(); }

void *SoftAPCommInterface::_GetBridgeDeviceAtIndex(int deviceIndex,
                                                   char *outErrorBuf) {
  return NULL;
  /*
  ...
  theDevice = this->_pcap->open(currentDevice->name, PACKET_SIZE,
  PCAP_OPENFLAG_PROMISCUOUS, 1, outErrorBuf); if(theDevice == NULL)
  {
...
bool SoftAPCommInterface::_IsDNSRequestToWFC(u16 ethertype, const u8 *body) {
  ...
  if (ntohs(ethertype) != 0x0800)
    return false; // EtherType: IP
  if (ipv4Header.version != 4)
    return false; // Version: 4
  if (ipv4Header.headerLen != 5)
    return false; // Header Length: 5
  if (ipv4Header.protocol != 0x11)
    return false; // Protocol: UDP
  if (ntohs(*(u16 *)&body[22]) != 53)
    return false; // Dest. port: 53 (DNS)
  if (htons(ntohs(*(u16 *)&body[28 + 2])) & 0x8000)
    return false; // must be a query
...
bool SoftAPCommInterface::Start(WifiHandler *currentWifiHandler) {
  ...
  if (isPCapSupported) {
    this->_bridgeDevice =
        this->_GetBridgeDeviceAtIndex(this->_bridgeDeviceIndex, errbuf);
  } else {
...
size_t SoftAPCommInterface::TXPacketSend(u8 *txTargetBuffer, size_t txLength) {
  ...
  if ((this->_bridgeDevice == NULL) || (txTargetBuffer == NULL) ||
      (txLength == 0)) {
    return txPacketSize;
  }

  int result =
      this->_pcap->sendpacket(this->_bridgeDevice, txTargetBuffer, txLength);
  if (result == 0) {
...
void SoftAPCommInterface::RXPacketGet() {
  ...
  if ((this->_bridgeDevice == NULL) || (this->_rawPacket == NULL) ||
      (this->_wifiHandler == NULL)) {
    return;
  }
  ...
  while (this->_isRXThreadRunning) {
    ...
    int result = this->_pcap->dispatch(this->_bridgeDevice, 8,
                                       (void *)&SoftAP_RXPacketGet_Callback,
                                       (u_char *)this->_rawPacket);
    if (result <= 0) {
      this->_rawPacket->count = 0;
    } else {
...
const u8 *WifiHandler::_RXPacketFilter(const u8 *rxBuffer, const size_t rxBytes,
                                       RXPacketHeader &outRXHeader) {
  WifiData &wifi = this->_wifi;
  WIFI_IOREG_MAP &io = wifi.io;
  ...
  if (strncmp(desmumeFrameHeader->frameID, DESMUME_EMULATOR_FRAME_ID,
              sizeof(desmumeFrameHeader->frameID)) == 0) {
    ...
    case 0x10: {
      ...
      if (desmumeFrameHeader->emuPacketSize >
          (rxBytes - sizeof(DesmumeFrameHeader))) {
  ...
  case WifiFrameType_Management: {
    ...
    default:
      willAcceptPacket =
          WIFI_compareMAC(io.MACADDR,
                          &packetIEEE80211HeaderPtr[destMACOffset]) ||
          (WIFI_isBroadcastMAC(&packetIEEE80211HeaderPtr[destMACOffset]) &&
           WIFI_compareMAC(io.BSSID, &packetIEEE80211HeaderPtr[BSSIDOffset]));
      break;
    }
    break;
  }
  ...
  case WifiFrameType_Control: {
    ...
    case WifiFrameControlSubtype_RTS:
      ...
      willAcceptPacket =
          WIFI_compareMAC(io.MACADDR, &packetIEEE80211HeaderPtr[destMACOffset]);
      break;
  ...
  // Don't process packets that we just sent.
  const bool isReceiverSameAsSender =
      (sendMACOffset != 0xFFFFFFFF) &&
      WIFI_compareMAC(io.MACADDR, &packetIEEE80211HeaderPtr[sendMACOffset]);
  ...
  // Filter broadcast because of privacy. They aren't needed to study the
  // protocol with the nintendo server and can include PC Discovery protocols
  ...
  outRXHeader = WIFI_GenerateRXHeader(packetIEEE80211HeaderPtr, 1, isTXRate20,
                                      rxPacketSize);
  return packetIEEE80211HeaderPtr;
}
...
void WifiHandler::_PacketCaptureFileOpen() {
  ...
  char file_name[50];
  sprintf(file_name, "%c%c%c%c [%02d-%02d-%02d-%02d].pcap", gamecd[0],
          gamecd[1], gamecd[2], gamecd[3], t->tm_mday, t->tm_hour, t->tm_min,
          t->tm_sec);
...
void WifiHandler::_PacketCaptureFileWrite(const u8 *packet, u32 len,
                                          bool isReceived, u64 timeStamp) {
  if (this->_packetCaptureFile == NULL) {
  ...
  fwrite(&seconds, sizeof(char), 4,
         this->_packetCaptureFile); // This should be seconds since Unix Epoch,
                                    // but it works :D
...
RXQueuedPacket
WifiHandler::_GenerateSoftAPDeauthenticationFrame(u16 sequenceNumber) {
  RXQueuedPacket newRXPacket;

  u8 *IEEE80211FrameHeaderPtr = newRXPacket.rxData;
  WifiMgmtFrameHeader &mgmtFrameHeader =
      (WifiMgmtFrameHeader &)IEEE80211FrameHeaderPtr[0];

  memcpy(IEEE80211FrameHeaderPtr, SoftAP_DeauthFrame,
         sizeof(SoftAP_DeauthFrame));
  ...
  newRXPacket.rxHeader = WIFI_GenerateRXHeader(newRXPacket.rxData, 1, true,
                                               sizeof(SoftAP_DeauthFrame));
...
RXQueuedPacket WifiHandler::_GenerateSoftAPBeaconFrame(u16 sequenceNumber,
  ...
  *(u64 *)mgmtFrameBody = timeStamp;
  ...
  newRXPacket.rxHeader = WIFI_GenerateRXHeader(IEEE80211FrameHeaderPtr, 1, true,
                                               sizeof(SoftAP_Beacon));

  return newRXPacket;
}

RXQueuedPacket WifiHandler::_GenerateSoftAPMgmtResponseFrame(
    WifiFrameManagementSubtype mgmtFrameSubtype, u16 sequenceNumber,
    u64 timeStamp) {
  RXQueuedPacket newRXPacket;
  ...
  newRXPacket.rxHeader =
      WIFI_GenerateRXHeader(IEEE80211FrameHeaderPtr, 1, true, packetLen);

  return newRXPacket;
}

RXQueuedPacket WifiHandler::_GenerateSoftAPCtlACKFrame(
    const WifiDataFrameHeaderSTA2DS &inIEEE80211FrameHeader,
    const size_t sendPacketLength) {
  RXQueuedPacket newRXPacket;

  u8 *outIEEE80211FrameHeaderPtr = newRXPacket.rxData;
  WifiCtlFrameHeaderACK &outCtlFrameHeader =
      (WifiCtlFrameHeaderACK &)outIEEE80211FrameHeaderPtr[0];
  ...
  outCtlFrameHeader.duration =
      (inIEEE80211FrameHeader.fc.MoreFragments == 0) ? 0 : sendPacketLength * 4;
  ...
  fcs =
      WIFI_calcCRC32(outIEEE80211FrameHeaderPtr, sizeof(WifiCtlFrameHeaderACK));

  newRXPacket.rxHeader = WIFI_GenerateRXHeader(
      outIEEE80211FrameHeaderPtr, 1, true, sizeof(WifiCtlFrameHeaderACK));

  return newRXPacket;
}

bool WifiHandler::_SoftAPTrySendPacket(const TXPacketHeader &txHeader,
                                       const u8 *IEEE80211PacketData) {
  bool isPacketHandled = false;
  const WifiFrameControl &fc = (WifiFrameControl &)IEEE80211PacketData[0];

  switch ((WifiFrameType)fc.Type) {
  case WifiFrameType_Management: {
    const WifiMgmtFrameHeader &mgmtFrameHeader =
        (WifiMgmtFrameHeader &)IEEE80211PacketData[0];

    if (WIFI_compareMAC(mgmtFrameHeader.BSSID, SoftAP_MACAddr) ||
        (WIFI_isBroadcastMAC(mgmtFrameHeader.BSSID) &&
         (fc.Subtype == WifiFrameManagementSubtype_ProbeRequest))) {
      slock_lock(this->_mutexRXPacketQueue);

      RXQueuedPacket newRXPacket = this->_GenerateSoftAPMgmtResponseFrame(
          (WifiFrameManagementSubtype)fc.Subtype, this->_softAPSequenceNumber,
          this->_wifi.usecCounter);
  ...
  case WifiFrameType_Control: {
    ...
    // assume that the packet is always handled as long as it is destined for
    // SoftAP.

    switch ((WifiFrameControlSubtype)fc.Subtype) {
    case WifiFrameControlSubtype_PSPoll: {
      const WifiCtlFrameHeaderPSPoll &ctlFrameHeader =
          (WifiCtlFrameHeaderPSPoll &)IEEE80211PacketData[0];
      isPacketHandled = WIFI_compareMAC(ctlFrameHeader.BSSID, SoftAP_MACAddr);
      break;
    }

    case WifiFrameControlSubtype_RTS: {
      const WifiCtlFrameHeaderRTS &ctlFrameHeader =
          (WifiCtlFrameHeaderRTS &)IEEE80211PacketData[0];
      isPacketHandled = WIFI_compareMAC(ctlFrameHeader.rxMAC, SoftAP_MACAddr);
      break;
    }

    case WifiFrameControlSubtype_CTS: {
      const WifiCtlFrameHeaderCTS &ctlFrameHeader =
          (WifiCtlFrameHeaderCTS &)IEEE80211PacketData[0];
      isPacketHandled = WIFI_compareMAC(ctlFrameHeader.rxMAC, SoftAP_MACAddr);
      break;
    }

    case WifiFrameControlSubtype_ACK: {
      const WifiCtlFrameHeaderACK &ctlFrameHeader =
          (WifiCtlFrameHeaderACK &)IEEE80211PacketData[0];
      isPacketHandled = WIFI_compareMAC(ctlFrameHeader.rxMAC, SoftAP_MACAddr);
      break;
    }

    case WifiFrameControlSubtype_End: {
      const WifiCtlFrameHeaderEnd &ctlFrameHeader =
          (WifiCtlFrameHeaderEnd &)IEEE80211PacketData[0];
      isPacketHandled = WIFI_compareMAC(ctlFrameHeader.rxMAC, SoftAP_MACAddr);
      break;
    }

    case WifiFrameControlSubtype_EndAck: {
      const WifiCtlFrameHeaderEndAck &ctlFrameHeader =
          (WifiCtlFrameHeaderEndAck &)IEEE80211PacketData[0];
      isPacketHandled = WIFI_compareMAC(ctlFrameHeader.rxMAC, SoftAP_MACAddr);
      break;
    }
  ...
  case WifiFrameType_Data: {
    if (fc.FromToState == WifiFCFromToState_STA2DS) {
      const WifiDataFrameHeaderSTA2DS &IEEE80211FrameHeader =
          (WifiDataFrameHeaderSTA2DS &)IEEE80211PacketData[0];

      if (WIFI_compareMAC(IEEE80211FrameHeader.BSSID, SoftAP_MACAddr) &&
          (this->_softAPStatus == APStatus_Associated)) {
        size_t sendPacketSize = WifiHandler::ConvertDataFrame80211To8023(
            IEEE80211PacketData, txHeader.length, this->_workingTXBuffer);
        if (sendPacketSize > 0) {
          sendPacketSize = this->_softAPCommInterface->TXPacketSend(
              this->_workingTXBuffer, sendPacketSize);
          if (sendPacketSize > 0) {
            RXQueuedPacket newRXPacket = this->_GenerateSoftAPCtlACKFrame(
                IEEE80211FrameHeader, sendPacketSize);
            newRXPacket.latencyCount = 0;
            ...
            this->_PacketCaptureFileWrite(this->_workingTXBuffer,
                                          sendPacketSize, false,
                                          this->_wifi.usecCounter);
#endif
          }
        }
...
bool WifiHandler::_AdhocTrySendPacket(const TXPacketHeader &txHeader,
                                      const u8 *IEEE80211PacketData) {
  ...
  DesmumeFrameHeader &emulatorHeader =
      (DesmumeFrameHeader &)this->_workingTXBuffer[0];
  strncpy(emulatorHeader.frameID, DESMUME_EMULATOR_FRAME_ID, 8);
  emulatorHeader.version = DESMUME_EMULATOR_FRAME_CURRENT_VERSION;
  emulatorHeader.timeStamp = 0;
  ...
  memcpy(this->_workingTXBuffer + emulatorHeaderSize, IEEE80211PacketData,
         txHeader.length);

  this->_adhocCommInterface->TXPacketSend(this->_workingTXBuffer,
                                          emulatorPacketSize);
...
WifiData &WifiHandler::GetWifiData() { return this->_wifi; }
...
int WifiHandler::GetBridgeDeviceList(
...
bool WifiHandler::CommStart() {
  ...
  WIFI_LOG(1, "MAC Address = %02X:%02X:%02X:%02X:%02X:%02X\n", FW_Mac[0],
           FW_Mac[1], FW_Mac[2], FW_Mac[3], FW_Mac[4], FW_Mac[5]);

  // Allocate 16KB worth of memory per buffer for sending packets. Hopefully,
  ...
  this->_softAPCommInterface->SetBridgeDeviceIndex(
      this->_selectedBridgeDeviceIndex);
  ...
  if (this->_selectedEmulationLevel == WifiEmulationLevel_Off) {
    ...
    if (this->_isSocketsSupported) {
      ...
      WIFI_LOG(1, "Ad-hoc mode requires sockets, but sockets are not supported "
                  "on this system.\n");
    }
    ...
    if (this->IsPCapSupported()) {
      ...
      WIFI_LOG(1,
               "Infrastructure mode requires libpcap for full functionality,\n "
               "     but libpcap is not available on this system. Network "
...
void WifiHandler::CommSendPacket(const TXPacketHeader &txHeader,
                                 const u8 *IEEE80211PacketData) {
...
void WifiHandler::CommTrigger() {
  ...
  if ((io.US_COUNT & 3) == 0) {
    ...
    case WifiTXLocIndex_LOC3:
      ...
      break;
      // case WifiTXLocIndex_BEACON: isTXSlotBusy = (io.TXBUSY.Beacon != 0);
      // break;
    ...
    if (isTXSlotBusy) {
      ...
      switch (txSlotIndex) {
      case WifiTXLocIndex_LOC1:
        txBufLocation = &io.TXBUF_LOC1;
        break;
      // case WifiTXLocIndex_CMD: txBufLocation = &io.TXBUF_CMD; break;
      case WifiTXLocIndex_LOC2:
        txBufLocation = &io.TXBUF_LOC2;
        break;
      case WifiTXLocIndex_LOC3:
        txBufLocation = &io.TXBUF_LOC3;
        break;
      ...
      if (txPacketInfo.remainingBytes == 0) {
        ...
        TXPacketHeader &txHeader =
            (TXPacketHeader &)wifi.RAM[txBufLocation->HalfwordAddress << 1];
        this->CommSendPacket(txHeader,
                             &wifi.RAM[(txBufLocation->HalfwordAddress << 1) +
                                       sizeof(TXPacketHeader)]);
        txHeader.txStatus = 0x0001;
        txHeader.UNKNOWN3 = 0;
        ...
        case WifiTXLocIndex_LOC1:
          io.TXSTAT.PacketUpdate = 0;
          break;
        case WifiTXLocIndex_LOC2:
          io.TXSTAT.PacketUpdate = 1;
          break;
        case WifiTXLocIndex_LOC3:
          io.TXSTAT.PacketUpdate = 2;
          break;
        ...
        while (!isTXSlotBusy && (wifi.txCurrentSlot != WifiTXLocIndex_LOC1)) {
          ...
          if (wifi.txCurrentSlot == WifiTXLocIndex_LOC3) {
            wifi.txCurrentSlot = WifiTXLocIndex_LOC2;
            isTXSlotBusy = (io.TXBUSY.Loc2 != 0);
        ...
        WIFI_LOG(3,
                 "TX slot %i finished sending its packet. Next is slot %i. "
                 "TXStat = %04X\n",
...
void WifiHandler::_AddPeriodicPacketsToRXQueue(const u64 usecCounter) {
  if ((usecCounter & 131071) == 0) {
    ...
    // zero sez: every 1/10 second? does it have to be precise? this is so
    // costly..
    //  Okay for 128 ms then
    RXQueuedPacket newRXPacket = this->_GenerateSoftAPBeaconFrame(
        this->_softAPSequenceNumber, this->_wifi.usecCounter);
    newRXPacket.latencyCount = 0;
...
void WifiHandler::_CopyFromRXQueue() {
  ...
  // Retrieve a packet from the RX packet queue if we're not already working on
  // one.
  ...
  const size_t totalPacketLength =
      (this->_rxCurrentPacket.rxHeader.length > MAX_PACKET_SIZE_80211)
          ? sizeof(RXPacketHeader) + MAX_PACKET_SIZE_80211
          : sizeof(RXPacketHeader) + this->_rxCurrentPacket.rxHeader.length;
  this->_rxCurrentPacket.latencyCount++;

  // If the user selects compatibility mode, then we will emulate the transfer
  // delays involved with copying RX packet data into WiFi RAM. Otherwise, just
  // copy all of the RX packet data into WiFi RAM immediately.
  if (this->_currentEmulationLevel == WifiEmulationLevel_Compatibility) {
    // Copy the RX packet data into WiFi RAM over time.
    if ((this->_rxCurrentQueuedPacketPosition == 0) ||
        (this->_rxCurrentPacket.latencyCount >= RX_LATENCY_LIMIT)) {
      this->_RXWriteOneHalfword(
          *(u16 *)&this->_rxCurrentPacket
               .rawFrameData[this->_rxCurrentQueuedPacketPosition]);
  ...
  if (this->_rxCurrentQueuedPacketPosition >= totalPacketLength) {
    ...
    io.RXBUF_WRCSR.HalfwordAddress =
        ((io.RXBUF_WRCSR.HalfwordAddress + 1) & 0x0FFE);
    if (io.RXBUF_WRCSR.HalfwordAddress >= ((io.RXBUF_END & 0x1FFE) >> 1)) {
      io.RXBUF_WRCSR.HalfwordAddress = ((io.RXBUF_BEGIN & 0x1FFE) >> 1);
    }
...
void WifiHandler::CommEmptyRXQueue() { this->_RXEmptyQueue(); }
...
void WifiHandler::RXPacketRawToQueue(const RXRawPacketData &rawPacket) {
  ...
  for (size_t i = 0, readLocation = 0; i < rawPacket.count; i++) {
    ...
    const DesmumeFrameHeader &emulatorHeader =
        (DesmumeFrameHeader &)*currentPacket;
    readLocation += sizeof(DesmumeFrameHeader) + emulatorHeader.emuPacketSize;

    const u8 *packetIEEE80211HeaderPtr = this->_RXPacketFilter(
        currentPacket,
        sizeof(DesmumeFrameHeader) + emulatorHeader.emuPacketSize,
        newRXPacket.rxHeader);
    if (packetIEEE80211HeaderPtr != NULL) {
      memset(newRXPacket.rxData, 0, sizeof(newRXPacket.rxData));
      memcpy(newRXPacket.rxData, packetIEEE80211HeaderPtr,
             newRXPacket.rxHeader.length);
      newRXPacket.latencyCount = 0;

      if (WILLADVANCESEQNO) {
        // Update the sequence number.
        WifiDataFrameHeaderDS2STA &IEEE80211Header =
            (WifiDataFrameHeaderDS2STA &)newRXPacket.rxData[0];
...
bool WifiHandler::IsSocketsSupported() { return this->_isSocketsSupported; }

void WifiHandler::SetSocketsSupported(bool isSupported) {
  this->_isSocketsSupported = isSupported;
}

ClientPCapInterface *WifiHandler::GetPCapInterface() { return this->_pcap; }
...
void WifiHandler::PrepareSaveStateWrite() {
  ...
  memcpy(legacyWifiSF.bb_data, this->_wifi.bb.data,
         sizeof(this->_wifi.bb.data));
...
void WifiHandler::ParseSaveStateRead() {
  ...
  memcpy(this->_wifi.bb.data, legacyWifiSF.bb_data,
         sizeof(this->_wifi.bb.data));
  memcpy(this->_wifi.RAM, legacyWifiSF.wifiRAM, sizeof(this->_wifi.RAM));
}

size_t WifiHandler::ConvertDataFrame80211To8023(const u8 *inIEEE80211Frame,
  ...
  // Ensure that the incoming 802.11 frame is a STA-to-DS data frame with a
  // LLC/SNAP header.
  if ((fc.Type != WifiFrameType_Data) ||
      (fc.FromToState != WifiFCFromToState_STA2DS) ||
      !WIFI_IsLLCSNAPHeader(inIEEE80211Frame +
                            sizeof(WifiDataFrameHeaderSTA2DS))) {
    return sendPacketSize;
  }

  const WifiDataFrameHeaderSTA2DS &IEEE80211FrameHeader =
      (WifiDataFrameHeaderSTA2DS &)inIEEE80211Frame[0];
  const WifiLLCSNAPHeader &snapHeader =
      (WifiLLCSNAPHeader &)inIEEE80211Frame[sizeof(WifiDataFrameHeaderSTA2DS)];
  const u8 *inFrameBody = inIEEE80211Frame + sizeof(WifiDataFrameHeaderSTA2DS) +
                          sizeof(WifiLLCSNAPHeader);

  EthernetFrameHeader &IEEE8023FrameHeader =
      (EthernetFrameHeader &)outIEEE8023Frame[0];
  ...
  sendPacketSize = txLength - sizeof(WifiDataFrameHeaderSTA2DS) -
                   sizeof(WifiLLCSNAPHeader) - sizeof(u32) +
                   sizeof(EthernetFrameHeader);
  memcpy(outFrameBody, inFrameBody,
         sendPacketSize - sizeof(EthernetFrameHeader));

  return sendPacketSize;
}

size_t WifiHandler::ConvertDataFrame8023To80211(const u8 *inIEEE8023Frame,
                                                const size_t rxLength,
                                                u8 *outIEEE80211Frame) {
  size_t sendPacketSize = 0;

  // Convert the libpcap 802.3 header into an NDS-compatible 802.11 header.
  const EthernetFrameHeader &IEEE8023Header =
      (EthernetFrameHeader &)inIEEE8023Frame[0];
  WifiDataFrameHeaderDS2STA &IEEE80211Header =
      (WifiDataFrameHeaderDS2STA &)outIEEE80211Frame[0];
  ...
  IEEE80211Header.seqCtl.value =
      0; // This is 0 for now, but will need to be set later.

  // 802.3 to 802.11 LLC/SNAP header
  WifiLLCSNAPHeader &snapHeader =
      (WifiLLCSNAPHeader &)outIEEE80211Frame[sizeof(WifiDataFrameHeaderDS2STA)];
  snapHeader = DefaultSNAPHeader;
  snapHeader.ethertype = IEEE8023Header.ethertype;

  // Packet body
  u8 *packetBody = outIEEE80211Frame + sizeof(WifiDataFrameHeaderDS2STA) +
                   sizeof(WifiLLCSNAPHeader);
  memcpy(packetBody, (u8 *)inIEEE8023Frame + sizeof(EthernetFrameHeader),
         rxLength - sizeof(EthernetFrameHeader));

  sendPacketSize = rxLength + sizeof(WifiDataFrameHeaderDS2STA) +
                   sizeof(WifiLLCSNAPHeader) - sizeof(EthernetFrameHeader);
  return sendPacketSize;
}
