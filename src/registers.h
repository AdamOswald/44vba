...
#define REG_DISPA_DISP3DCNT_BITS_ACK                                           \
  (REG_DISPA_DISP3DCNT_BIT_RDLINES_UNDERFLOW |                                 \
   REG_DISPA_DISP3DCNT_BIT_RAM_OVERFLOW)
...
#define IPCFIFOCNT_WRITEABLE                                                   \
  (IPCFIFOCNT_SENDIRQEN | IPCFIFOCNT_RECVIRQEN | IPCFIFOCNT_FIFOENABLE)
