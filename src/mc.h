...
// This "backup device" represents a typical retail NDS save memory accessible
// via AUXSPI. It is managed as a core emulator service for historical reasons
// which are bad, and possible infrastructural simplification reasons which are
// good. Slot-1 devices will map their AUXSPI accesses through to the
