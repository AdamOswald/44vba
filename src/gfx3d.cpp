...
//---------------
// TODO TODO TODO TODO
// make up mind once and for all whether fog, toon, etc. should reside in memory
// buffers (for easier handling in MMU) if they do, then we need to copy them
// out in doFlush!!!
//---------------

// old tests of matrix stack:
// without the mymode==(texture) namco classics galaxian will try to use pos=1
// and overrun the stack, corrupting emu according to gbatek, 31 works but sets
// the stack overflow flag. spider-man 2 tests this on the spiderman model (and
// elsewhere) see "Tony Hawk's American Sk8land" work from revision
// 07806eb8364d1eb2d21dd3fe5234c9abe0a8a894 from MatrixStackSetStackPosition:
// "once upon a time, we tried clamping to the size. this utterly broke sims 2
// apartment pets. changing to wrap around made it work perfectly" Water Horse
// Legend Of The Deep does seem to exercise the texture matrix stack, which does
// probably need to exist *but I'm not 100% sure)
...
I think a flush is supposed to queue up and wait to happen during vblank
sometime. But, we have some games that continue to do work after a flush but
before a vblank. Since our timing is bad anyway, and we're not sure when the
flush is really supposed to happen, then this leaves us in a bad situation. What
makes it worse is that if flush is supposed to be deferred, then we have to
queue these errant geometry commands. That would require a better gxfifo we have
now, and some mechanism to block while the geometry engine is stalled (which
doesnt exist). Since these errant games are nevertheless using flush command to
represent the end of a frame, we deem this a good time to execute an actual
flush. I think we originally didnt do this because we found some game that it
glitched, but that may have been resolved since then by deferring actual
rendering to the next vcount=0 (giving textures enough time to upload). But
since we're not sure how we'll eventually want this, I am leaving it sort of
reconfigurable, doing all the work in this function: */
...
static const u8 gfx3d_commandTypes[] = {
    /* 00 */ 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, // invalid commands; no parameters
    /* 10 */ 0x01, 0x00, 0x01, 0x01, 0x01, 0x00, 0x10, 0x0C, 0x10, 0x0C, 0x09,
    0x03, 0x03, 0xCC, 0xCC, 0xCC, // matrix commands
    /* 20 */ 0x01, 0x01, 0x01, 0x02, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
    0x01, 0xCC, 0xCC, 0xCC, 0xCC, // vertex and per-vertex material commands
    /* 30 */ 0x01, 0x01, 0x01, 0x01, 0x20, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, // lighting engine material commands
    /* 40 */ 0x01, 0x00, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, // begin and end
    /* 50 */ 0x01, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, // swapbuffers
    /* 60 */ 0x01, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, // viewport
    /* 70 */ 0x03, 0x02, 0x01, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC, // tests
    // 0x80:
    /* 80 */ 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    /* 90 */ 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    /* A0 */ 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    /* B0 */ 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    /* C0 */ 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    /* D0 */ 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    /* E0 */ 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    /* F0 */ 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,
    0xCC, 0xCC, 0xCC, 0xCC, 0xCC};
...
public:
  ...
  void receive(u32 val) {
    // so, it seems as if the dummy values and restrictions on the highest-order
    // command in the packed command set is solely about some unknown internal
    // timing quirk, and not about the logical behaviour of the state machine.
    // it's possible that writing some values too quickly can result in the
    // gxfifo not being ready. this would be especially troublesome when they're
    // getting DMA'd nonstop with no delay. so, since the timing is not emulated
    // rigorously here, and only the logic, we shouldn't depend on or expect the
    // dummy values. indeed, some games aren't issuing them, and will break if
    // they are expected. however, since the dummy values seem to be 0x00000000
    // always, theyre benign to the state machine, even if the HW timing doesnt
    // require them. the actual logical rule seem to be:
    // 1. commands with no arguments are executed as soon as possible; when the
    // packed command is first received, or immediately after the preceding
    // N-arg command. 1a. for example, a 0-arg command following an N-arg
    // command doesn't require a dummy value 1b. for example, two 0-arg commands
    // constituting a packed command will execute immediately when the packed
    // command is received.
    //
    ...
    // this 0 param is meant for the 0x10 mtxMode command. dummy args aren't
    // supplied for the 0x11 or 0x15. but other times, the game will issue dummy
    // parameters. Either this is because the rules are more complex (do only
    // certain 0-arg commands require dummies?), or the game made a mistake in
    // applying the rules, which didnt seem to irritate the hypothetical HW
    // timing quirk. yet, another time, it will issue the dummy: 0x00004123 (XYZ
    // vertex) 0x0c000400 (arg1) 0x00000000 (arg2) 0x00000000 (dummy for 0x41)
    ...
    for (;;) {
      ...
      if (currCommandType == GFX_UNDEFINED_COMMAND)
        ...
        // since the general goal here is to process packed commands until we
        // have none left (0's will be shifted in) we can just skip this command
        // and continue processing if theres anything left to process.
        shiftCommand >>= 8;
      } else if (currCommandType == GFX_INVALID_COMMAND) {
        // break when the current command is invalid. 0x00 is invalid; this is
        // what gets used to terminate a loop after all the commands are handled
        break;
      } else {
...
// these were 4 for the longest time (this is MUCH, MUCH less than their
// theoretical values) but it was changed to 1 for strawberry shortcake, which
// was issuing direct commands while the fifo was full, apparently expecting the
// fifo not to be full by that time. in general we are finding that 3d takes
// less time than we think.... although maybe the true culprit was charging the
// cpu less time for the dma.
...
static CACHE_ALIGN FragmentColor
    _gfx3d_savestateBuffer[GPU_FRAMEBUFFER_NATIVE_WIDTH *
...
//-----------cached things:
// these dont need to go into the savestate. they can be regenerated from HW
// registers from polygonattr:
static u32 lightMask = 0;
// other things:
static TextureTransformationMode texCoordTransformMode =
    TextureTransformationMode_None;
...
static void makeTables() {
  for (size_t i = 0; i < 32768; i++) {
    // 15-bit to 24-bit depth formula from
    // http://problemkaputt.de/gbatek.htm#ds3drearplane
    // dsDepthExtend_15bit_to_24bit[i] = LE_TO_LOCAL_32( (i*0x0200) +
    // ((i+1)>>15)*0x01FF );

    // Is GBATEK actually correct here? Let's try using a simplified formula and
    // see if it's more accurate.
...
void gfx3d_init() {
  ...
  // Use malloc() instead of new because, for some unknown reason, GCC 4.9 has a
  // bug that causes a std::bad_alloc exception on certain memory allocations.
  // Right now, POLYLIST and VERT are POD-style structs, so malloc() can
  // substitute for new in this case.
  if (polylists == NULL) {
...
void gfx3d_reset() {
  ...
  memset(_gfx3d_savestateBuffer, 0,
...
FORCEINLINE s32 vec3dot_fixed32(const s32 *a, const s32 *b) {
  return sfx32_shiftdown(fx32_mul(a[0], b[0]) + fx32_mul(a[1], b[1]) +
                         fx32_mul(a[2], b[2]));
}

//---------------
// I'm going to start name these functions GE for GEOMETRY ENGINE MATH.
// Pretty much any math function in this file should be explicit about how it's
// handling precision. Handling that stuff generically globally is not a winning
// proposition.
...
static s32 GEM_SaturateAndShiftdown36To32(const s64 val) {
  ...
  if (val < (s64)0xFFFFF80000000000ULL)
    return (s32)0x80000000U;

  return fx32_shiftdown(val);
}

static void GEM_TransformVertex(const s32 (&__restrict mtx)[16],
                                s32 (&__restrict vec)[4]) {
  const s32 x = vec[0];
  const s32 y = vec[1];
  const s32 z = vec[2];
  const s32 w = vec[3];
  ...
  //+ spectrobes beyond the portals excavation blower and drill tools: sets very
  //large overflowing +x,+y in the modelview matrix to push things offscreen You
  // can see this happening quite clearly: vertices will get translated to
  // extreme values and overflow from a 7FFF-like to an 8000-like but if it's
  // done wrongly, you can get bugs in:
  //+ kingdom hearts re-coded: first conversation with cast characters will
  //place them oddly with something overflowing to about 0xA???????

  // other test cases that cropped up during this development, but are probably
  // not actually related to this after all
  //+ SM64: outside castle skybox
  //+ NSMB: mario head screen wipe

  vec[0] = GEM_SaturateAndShiftdown36To32(
      GEM_Mul32x32To64(x, mtx[0]) + GEM_Mul32x32To64(y, mtx[4]) +
      GEM_Mul32x32To64(z, mtx[8]) + GEM_Mul32x32To64(w, mtx[12]));
  vec[1] = GEM_SaturateAndShiftdown36To32(
      GEM_Mul32x32To64(x, mtx[1]) + GEM_Mul32x32To64(y, mtx[5]) +
      GEM_Mul32x32To64(z, mtx[9]) + GEM_Mul32x32To64(w, mtx[13]));
  vec[2] = GEM_SaturateAndShiftdown36To32(
      GEM_Mul32x32To64(x, mtx[2]) + GEM_Mul32x32To64(y, mtx[6]) +
      GEM_Mul32x32To64(z, mtx[10]) + GEM_Mul32x32To64(w, mtx[14]));
  vec[3] = GEM_SaturateAndShiftdown36To32(
      GEM_Mul32x32To64(x, mtx[3]) + GEM_Mul32x32To64(y, mtx[7]) +
      GEM_Mul32x32To64(z, mtx[11]) + GEM_Mul32x32To64(w, mtx[15]));
}
//---------------

#define SUBMITVERTEX(ii, nn)                                                   \
  polylist->list[polylist->count].vertIndexes[ii] = tempVertInfo.map[nn];
// Submit a vertex to the GE
static void SetVertex() {
  s32 coord[3] = {s16coord[0], s16coord[1], s16coord[2]};

  DS_ALIGN(16)
  s32 coordTransformed[4] = {coord[0], coord[1], coord[2], (1 << 12)};

  if (texCoordTransformMode == TextureTransformationMode_VertexSource) {
    // Tested by: Eledees The Adventures of Kai and Zero (E) [title screen and
    // frontend menus]
    const s32 *mtxTex = mtxCurrent[MATRIXMODE_TEXTURE];
    last_s = (s32)((s64)(GEM_Mul32x16To64(mtxTex[0], s16coord[0]) +
                         GEM_Mul32x16To64(mtxTex[4], s16coord[1]) +
                         GEM_Mul32x16To64(mtxTex[8], s16coord[2]) +
                         ((s64)_s << 24)) >>
                   24);
    last_t = (s32)((s64)(GEM_Mul32x16To64(mtxTex[1], s16coord[0]) +
                         GEM_Mul32x16To64(mtxTex[5], s16coord[1]) +
                         GEM_Mul32x16To64(mtxTex[9], s16coord[2]) +
                         ((s64)_t << 24)) >>
                   24);
  }
  ...
  if (freelookMode == 2) {
    ...
    GEM_TransformVertex(mtxCurrent[MATRIXMODE_POSITION],
                        coordTransformed);      // modelview
    ...
    GEM_TransformVertex(mtxCurrent[MATRIXMODE_POSITION],
                        coordTransformed); // modelview
    GEM_TransformVertex(mtxCurrent[MATRIXMODE_PROJECTION],
                        coordTransformed); // projection
  }
  ...
  const size_t vertIndex =
      vertListCount[listTwiddle] + tempVertInfo.count - continuation;
  ...
  vert.color_to_float();
  tempVertInfo.map[tempVertInfo.count] =
      vertListCount[listTwiddle] + tempVertInfo.count - continuation;
  tempVertInfo.count++;
  ...
  // possibly complete a polygon
  {
    ...
    case GFX3D_TRIANGLES:
      ...
      // vertlist->list[polylist->list[polylist->count].vertIndexes[i] =
      // vertlist->count++] = tempVertList.list[n];
      SUBMITVERTEX(0, 0);
      SUBMITVERTEX(1, 1);
      SUBMITVERTEX(2, 2);
    ...
    if (polygonListCompleted == 1) {
      ...
      // Line segment detect
      // Tested" Castlevania POR - warp stone, trajectory of ricochet, "Eye of
      // Decay"
      if (currentPolyTexParam.PackedFormat == TEXMODE_NONE) {
        ...
        if ((vert0.x == vert1.x) && (vert0.y == vert1.y))
          duplicated = true;
        else if ((vert1.x == vert2.x) && (vert1.y == vert2.y))
          duplicated = true;
        else if ((vert0.y == vert1.y) && (vert1.y == vert2.y))
          duplicated = true;
        else if ((vert0.x == vert1.x) && (vert1.x == vert2.x))
          duplicated = true;
        if (duplicated) {
          // printf("Line Segmet detected (poly type %i, mode %i, texparam
...
static void gfx3d_glTexImage_cache() {
  texCoordTransformMode =
      (TextureTransformationMode)currentPolyTexParam.TexCoordTransformMode;
}
...
static void gfx3d_glLightDirection_cache(const size_t index) {
  ...
  MatrixMultVec3x3(mtxCurrent[MATRIXMODE_POSITION_VECTOR],
                   cacheLightDirection[index]);

  // Calculate the half angle vector
  s32 lineOfSight[4] = {0, 0, (-1) << 12, 0};
  for (size_t i = 0; i < 4; i++) {
    cacheHalfVector[index][i] =
        ((cacheLightDirection[index][i] + lineOfSight[i]));
  }

  // normalize the half angle vector
  // can't believe the hardware really does this... but yet it seems...
  s32 halfLength = ((s32)(sqrt((double)vec3dot_fixed32(
                       cacheHalfVector[index], cacheHalfVector[index]))))
                   << 6;
...
static void gfx3d_glPushMatrix() {
  // 1. apply offset specified by push (well, it's always +1) to internal
  // counter
  ...
  if (mode == MATRIXMODE_PROJECTION || mode == MATRIXMODE_TEXTURE) {
    ...
    MatrixCopy(mtxStackPosition.matrix[index & 31],
               mtxCurrent[MATRIXMODE_POSITION]);
    MatrixCopy(mtxStackPositionVector.matrix[index & 31],
...
static void gfx3d_glPopMatrix(u32 v) {
  ...
  if (mode == MATRIXMODE_PROJECTION || mode == MATRIXMODE_TEXTURE) {
    ...
    MatrixCopy(mtxCurrent[MATRIXMODE_POSITION],
               mtxStackPosition.matrix[index & 31]);
    MatrixCopy(mtxCurrent[MATRIXMODE_POSITION_VECTOR],
               mtxStackPositionVector.matrix[index & 31]);
  }
...
static void gfx3d_glStoreMatrix(u32 v) {
  ...
  if (mode == MATRIXMODE_PROJECTION || mode == MATRIXMODE_TEXTURE) {
    ...
    if (mode == MATRIXMODE_PROJECTION) {
      MatrixCopy(mtxStackProjection.matrix[0],
                 mtxCurrent[MATRIXMODE_PROJECTION]);
      UpdateProjection();
    } else {
    ...
    // out of bounds function fully properly, but set errors (not sure, this
    // might be off by 1)
    if (v >= 31)
      MMU_new.gxstat.se = 1;

    MatrixCopy(mtxStackPosition.matrix[v], mtxCurrent[MATRIXMODE_POSITION]);
    MatrixCopy(mtxStackPositionVector.matrix[v],
               mtxCurrent[MATRIXMODE_POSITION_VECTOR]);
  }
...
static void gfx3d_glRestoreMatrix(u32 v) {
  if (mode == MATRIXMODE_PROJECTION || mode == MATRIXMODE_TEXTURE) {
    ...
    if (mode == MATRIXMODE_PROJECTION) {
      MatrixCopy(mtxCurrent[MATRIXMODE_PROJECTION],
                 mtxStackProjection.matrix[0]);
      UpdateProjection();
    } else {
    ...
    MatrixCopy(mtxCurrent[MATRIXMODE_POSITION_VECTOR],
               mtxStackPositionVector.matrix[v]);
  }
...
static BOOL gfx3d_glScale(s32 v) {
  ...
  MatrixScale(
      mtxCurrent[(mode == MATRIXMODE_POSITION_VECTOR ? MATRIXMODE_POSITION
                                                     : mode)],
      scale);
...
static void gfx3d_glNormal(s32 v) {
  ...
  if (texCoordTransformMode == TextureTransformationMode_NormalSource) {
    ...
    // also smackdown 2010 player textures tested this (needed cast on _s and
    // _t)
    const s32 *mtxTex = mtxCurrent[MATRIXMODE_TEXTURE];
    last_s =
        (s32)((s64)(GEM_Mul32x32To64(mtxTex[0], normal[0]) +
                    GEM_Mul32x32To64(mtxTex[4], normal[1]) +
                    GEM_Mul32x32To64(mtxTex[8], normal[2]) + ((s64)_s << 24)) >>
              24);
    last_t =
        (s32)((s64)(GEM_Mul32x32To64(mtxTex[1], normal[0]) +
                    GEM_Mul32x32To64(mtxTex[5], normal[1]) +
                    GEM_Mul32x32To64(mtxTex[9], normal[2]) + ((s64)_t << 24)) >>
              24);
  }
  ...
  u8 diffuse[3] = {(u8)(dsDiffuse & 0x1F), (u8)((dsDiffuse >> 5) & 0x1F),
                   (u8)((dsDiffuse >> 10) & 0x1F)};

  u8 ambient[3] = {(u8)(dsAmbient & 0x1F), (u8)((dsAmbient >> 5) & 0x1F),
                   (u8)((dsAmbient >> 10) & 0x1F)};

  u8 emission[3] = {(u8)(dsEmission & 0x1F), (u8)((dsEmission >> 5) & 0x1F),
                    (u8)((dsEmission >> 10) & 0x1F)};

  u8 specular[3] = {(u8)(dsSpecular & 0x1F), (u8)((dsSpecular >> 5) & 0x1F),
  ...
  for (size_t i = 0; i < 4; i++) {
    ...
    u8 _lightColor[3] = {(u8)(lightColor[i] & 0x1F),
    ...
    s32 fixed_diffuse =
        std::max(0, -vec3dot_fixed32(cacheLightDirection[i], normal));

    // todo - this could be cached in this form
    s32 fixedTempNegativeHalf[] = {
        -cacheHalfVector[i][0], -cacheHalfVector[i][1], -cacheHalfVector[i][2],
        -cacheHalfVector[i][3]};
    ...
    {
      // we have cos(a). it seems that we need cos(2a). trig identity is a fast
      // way to get it. cos^2(a)=(1/2)(1+cos(2a)) 2*cos^2(a)-1=cos(2a)
    ...
    if (dsSpecular & 0x8000) {
      ...
      // the entries are 8bits each so <<4 gives us .12 again, compatible with
      // the lighting formulas below (according to other normal nds procedures,
      //we might should fill the bottom bits with 1 or 0 according to rules...)
      fixedshininess = gfx3d.state.shininessTable[fixedshininess >> 5] << 4;
    }

    for (size_t c = 0; c < 3; c++) {
      s32 specComp =
          ((specular[c] * _lightColor[c] * fixedshininess) >>
           17); // 5 bits for color*color and 12 bits for the shininess
      s32 diffComp =
          ((diffuse[c] * _lightColor[c] * fixed_diffuse) >>
           17); // 5bits for the color*color and 12 its for the diffuse
      s32 ambComp =
          ((ambient[c] * _lightColor[c]) >> 5); // 5bits for color*color
...
static void gfx3d_glTexCoord(s32 val) {
  ...
  if (texCoordTransformMode == TextureTransformationMode_TexCoordSource) {
    ...
    const s32 *mtxTex = mtxCurrent[MATRIXMODE_TEXTURE];
    last_s = (s32)((s64)(GEM_Mul32x32To64(mtxTex[0], _s) +
                         GEM_Mul32x32To64(mtxTex[4], _t) + (s64)mtxTex[8] +
                         (s64)mtxTex[12]) >>
                   12);
    last_t = (s32)((s64)(GEM_Mul32x32To64(mtxTex[1], _s) +
                         GEM_Mul32x32To64(mtxTex[5], _t) + (s64)mtxTex[9] +
                         (s64)mtxTex[13]) >>
                   12);
...
static void gfx3d_glVertex10b(s32 v) {
  // TODO TODO TODO - contemplate the sign extension - shift in zeroes or ones?
  // zeroes is certainly more normal..
...
template <int ONE, int TWO> static void gfx3d_glVertex3_cord(s32 v) {
...
static void gfx3d_glPolygonAttrib(u32 val) {
  if (inBegin) {
    ...
    // be activated until the next begin)\n");
...
/*
        ...
        15    Set Vertex Color (0=No, 1=Set Diffuse Reflection Color as Vertex
   Color) 16-20 Ambient Reflection Red 21-25 Ambient Reflection Green 26-30
   Ambient Reflection Blue
*/
...
/*
        0-9   Directional Vector's X component (1bit sign + 9bit fractional
   part) 10-19 Directional Vector's Y component (1bit sign + 9bit fractional
   part) 20-29 Directional Vector's Z component (1bit sign + 9bit fractional
   part) 30-31 Light Number                     (0..3)
*/
...
static BOOL gfx3d_glBoxTest(u32 v) {
  ...
  // garfields nightmare and strawberry shortcake DO DEPEND on the overflow
  // behavior.
  ...
  float xw =
      float16table[(ux + uw) & 0xFFFF]; //&0xFFFF not necessary for u16+u16
                                        //addition but added for emphasis
  ...
  for (size_t i = 0; i < 8; i++) {
    // this cant work. its left as a reminder that we could (and probably
    // should) do the boxtest in all fixed point values
    // MatrixMultVec4x4_M2(mtxCurrent[0], verts[i].coord);

    // but change it all to floating point and do it that way instead

    // DS_ALIGN(16) VERT_POS4f vert = { verts[i].x, verts[i].y, verts[i].z,
    // verts[i].w };

    //_MatrixMultVec4x4_NoSIMD(mtxCurrent[MATRIXMODE_POSITION], verts[i].coord);
    //_MatrixMultVec4x4_NoSIMD(mtxCurrent[MATRIXMODE_PROJECTION],
    //verts[i].coord);
  ...
  for (size_t i = 0; i < 6; i++) {
    ...
    const VERT *vertTable[4] = {
        &verts[thePoly.vertIndexes[0]], &verts[thePoly.vertIndexes[1]],
        &verts[thePoly.vertIndexes[2]], &verts[thePoly.vertIndexes[3]]};

    const bool isPolyUnclipped =
        boxtestClipper.ClipPoly<ClipperMode_DetermineClipOnly>(0, thePoly,
                                                               vertTable);
...
static BOOL gfx3d_glPosTest(u32 v) {
  // this is apparently tested by transformers decepticons and ultimate
  // spiderman
...
void VIEWPORT::decode(const u32 v) {
  // test: homie rollerz character select chooses nonsense for Y. they did the
  // math backwards. their goal was a fullscreen viewport, they just messed up.
  ...
  // the modular math is right. the details of how the +1 is handled may be
  // wrong (this might should be dealt with in the viewport transformation
  // instead) Its an off by one error in any event so we may never know
  width = (u8)(x2 - x1) + 1;
  height = (u8)(y2 - y1) + 1;
  x = x1;
  y = y1;
...
void gfx3d_glFogColor(u32 v) { gfx3d.state.fogColor = v; }

void gfx3d_glFogOffset(u32 v) { gfx3d.state.fogOffset = (v & 0x7FFF); }

void gfx3d_glClearDepth(u32 v) { gfx3d.state.clearDepth = DS_DEPTH15TO24(v); }
...
void gfx3d_glAlphaFunc(u32 v) { gfx3d.state.alphaTestRef = v & 0x1F; }
...
void gfx3d_execute3D() {
  ...
  for (size_t i = 0; i < HACK_FIFO_BATCH_SIZE; i++) {
    if (GFX_PIPErecv(&cmd, &param)) {
      // if (isSwapBuffers) printf("Executing while swapbuffers is pending:
      // %d:%08X\n",cmd,param);
      ...
      //..these guys will ordinarily set a delay, but multi-param operations
      //won't for the earlier params. printf("%05d:%03d:%12lld: executed 3d:
      ...
      // hacks for ridiculously fast 3d execution has proven necessary for a
      // number of games. the true answer is probably dma bus blocking.. but
      // lets go ahead and try this and check the compatibility, at the very
      // least it will be nice to know if any games suffer from 3d running too
      // fast
...
static bool gfx3d_ysort_compare(int num1, int num2) {
  ...
  // this may be verified by checking the game create menus in harvest moon
  // island of happiness also the buttons in the knights in the nightmare
  // frontend depend on this and the perspective division
  if (poly1.maxy != poly2.maxy)
    return (poly1.maxy < poly2.maxy);
  if (poly1.miny != poly2.miny)
    return (poly1.miny < poly2.miny);

  // notably, the main shop interface in harvest moon will not have a correct
  // RTN button i think this is due to a math error rounding its position to one
  // pixel too high and it popping behind the bar that it sits on. everything
  // else in all the other menus that I could find looks right..

  // make sure we respect the game's ordering in cases of complete ties
  // this makes it a stable sort.
  // this must be a stable sort or else advance wars DOR will flicker in the
  // main map mode
  return (num1 < num2);
}
...
void gfx3d_PerformClipping(const VERT *vtxList, const POLYLIST *polyList) {
  ...
  for (size_t polyIndex = 0, clipCount = 0; polyIndex < polyList->count;
       polyIndex++) {
    const POLY &poly = polyList->list[polyIndex];

    const VERT *clipVerts[4] = {
        &vtxList[poly.vertIndexes[0]], &vtxList[poly.vertIndexes[1]],
        &vtxList[poly.vertIndexes[2]],
        (poly.type == POLYGON_TYPE_QUAD) ? &vtxList[poly.vertIndexes[3]]
                                         : NULL};

    isPolyUnclipped =
        _clipper->ClipPoly<CLIPPERMODE>(polyIndex, poly, clipVerts);

    if (CLIPPERMODE == ClipperMode_DetermineClipOnly) {
      if (isPolyUnclipped) {
        _clippedPolyUnsortedList[polyIndex].index =
            _clipper->GetClippedPolyByIndex(clipCount).index;
        _clippedPolyUnsortedList[polyIndex].poly =
            _clipper->GetClippedPolyByIndex(clipCount).poly;
        clipCount++;
      }
    } else {
      if (isPolyUnclipped) {
        _clippedPolyUnsortedList[polyIndex] =
            _clipper->GetClippedPolyByIndex(clipCount);
        clipCount++;
      }
    }
  }
...
void gfx3d_GenerateRenderLists(const ClipperMode clippingMode) {
  ...
  case ClipperMode_FullColorInterpolate:
    gfx3d_PerformClipping<ClipperMode_FullColorInterpolate>(gfx3d.vertList,
                                                            gfx3d.polylist);
    break;

  case ClipperMode_DetermineClipOnly:
    gfx3d_PerformClipping<ClipperMode_DetermineClipOnly>(gfx3d.vertList,
                                                         gfx3d.polylist);
    break;
  }
  ...
  osd->addFixed(180, 20, "%i/%i", polycount,
                vertListCount[listTwiddle]);             // current
  ...
  // the w-division here is just an approximation to fix the shop in harvest
  // moon island of happiness also the buttons in the knights in the nightmare
  // frontend depend on this we process all polys here instead of just the
  // opaque ones (which have been sorted to the beginning of the index list
  // earlier) because
  // 1. otherwise it is basically two passes through the list and will probably
  // run slower than one pass through the list
  ...
  for (size_t i = 0; i < gfx3d.clippedPolyCount; i++) {
    ...
    // If both of these questions answer to yes, then how does the NDS handle a
    // NaN? For now, simply prevent w from being zero.
    POLY &poly = *_clipper->GetClippedPolyByIndex(i).poly;
    float verty = gfx3d.vertList[poly.vertIndexes[0]].y;
    float vertw = (gfx3d.vertList[poly.vertIndexes[0]].w != 0.0f)
                      ? gfx3d.vertList[poly.vertIndexes[0]].w
                      : 0.00000001f;
    ...
    for (size_t j = 1; j < poly.type; j++) {
      ...
      vertw = (gfx3d.vertList[poly.vertIndexes[j]].w != 0.0f)
                  ? gfx3d.vertList[poly.vertIndexes[j]].w
                  : 0.00000001f;
      verty = 1.0f - (verty + vertw) / (2 * vertw);
  ...
  std::sort(gfx3d.indexlist.list,
            gfx3d.indexlist.list + gfx3d.clippedPolyOpaqueCount,
            gfx3d_ysort_compare);
  ...
  if (!gfx3d.state.sortmode) {
    ...
    std::sort(gfx3d.indexlist.list + gfx3d.clippedPolyOpaqueCount,
              gfx3d.indexlist.list + gfx3d.clippedPolyCount,
              gfx3d_ysort_compare);
  }
  ...
  if (clippingMode == ClipperMode_DetermineClipOnly) {
    for (size_t i = 0; i < gfx3d.clippedPolyCount; i++) {
      _clippedPolySortedList[i].poly =
          _clippedPolyUnsortedList[gfx3d.indexlist.list[i]].poly;
    }
  } else {
    for (size_t i = 0; i < gfx3d.clippedPolyCount; i++) {
      _clippedPolySortedList[i] =
          _clippedPolyUnsortedList[gfx3d.indexlist.list[i]];
    }
  }
}
...
static void gfx3d_doFlush() {
  ...
  const ClipperMode clippingMode =
      CurrentRenderer->GetPreferredPolygonClippingMode();
  ...
  if (driver->view3d->IsRunning()) {
    ...
    memcpy(viewer3d_state->vertList, gfx3d.vertList,
           gfx3d.vertListCount * sizeof(VERT));
...
void gfx3d_VBlankSignal() {
  if (isSwapBuffers) {
    ...
    // in case the game isn't constantly restoring the projection matrix, we
    // want to ping lua
    UpdateProjection();
  }
}
...
void gfx3d_VBlankEndSignal(bool skipFrame) {
  ...
  // this is a wild guess. it isnt clear what various timings of powering off
  // and on will affect whether a valid frame renders its also part of an old
  // and probably bad guess.
  ...
  // HACK:
  // if a clear image is enabled, its contents could switch AT ANY TIME. Even if
  // no scene has been re-rendered. (Monster Trucks depends on this) therefore
  // we need to continually rerender. But for that matter, so too could texture
  // data. Do we continually re-render for that? Well, we have no evidence that
  // anyone does this. (seems useful for an FMV, maybe) But also, for that
  // matter, so too could CAPTURED DATA. Hopefully nobody does this. So, for
  // now, we're calling this a hack for the clear image only. It will increase
  // CPU load for apparently no purpose in some games which switch between heavy
  // 3d and 2d.. and that also use clear images.. that seems unlikely. This
  // could be a candidate for a per-game hack later if it proves unwieldy. Logic
  // to determine whether the contents have changed (due to register changes or
  // vram remapping to LCDC) are going to be really messy, but maybe workable if
  // everything else wasn't so messy. While we're on the subject, a game could
  // set a clear image and never even render anything. The time to fix this will
  // be when we rearchitect things to have more geometry processing lower-level
  // in GFX3D..
  ...
  if (gfx3d.state.enableClearImage) {
    ...
    // We're using this as a sentinel for whether anything's ever been
    // drawn--since we glitch out and crashing trying to render (if only for the
    // clear image) when no geometry's ever been swapped in
  ...
  const ClipperMode oldClippingMode =
      CurrentRenderer->GetPreferredPolygonClippingMode();
  GPU->Change3DRendererIfNeeded();
  const ClipperMode newClippingMode =
      CurrentRenderer->GetPreferredPolygonClippingMode();
...
// talks about the state required to process verts in quadlists etc. helpful
// ideas. consider building a little state structure that looks exactly like
// this describes
...
SFORMAT SF_GFX3D[] = {
    ...
    {"G3CX", 1, 4 * GPU_FRAMEBUFFER_NATIVE_WIDTH *GPU_FRAMEBUFFER_NATIVE_HEIGHT,
     _gfx3d_savestateBuffer},
    {0}};
...
void gfx3d_PrepareSaveStateBufferWrite() {
  ...
  if ((w == GPU_FRAMEBUFFER_NATIVE_WIDTH) &&
      (h == GPU_FRAMEBUFFER_NATIVE_HEIGHT)) // Framebuffer is at the native size
  {
    if (CurrentRenderer->GetColorFormat() == NDSColorFormat_BGR666_Rev) {
      ColorspaceConvertBuffer6665To8888<false, false>(
          (u32 *)CurrentRenderer->GetFramebuffer(),
          (u32 *)_gfx3d_savestateBuffer,
          GPU_FRAMEBUFFER_NATIVE_WIDTH * GPU_FRAMEBUFFER_NATIVE_HEIGHT);
    } else {
      ColorspaceCopyBuffer32<false, false>(
          (u32 *)CurrentRenderer->GetFramebuffer(),
          (u32 *)_gfx3d_savestateBuffer,
          GPU_FRAMEBUFFER_NATIVE_WIDTH * GPU_FRAMEBUFFER_NATIVE_HEIGHT);
    }
  } else // Framebuffer is at a custom size
  {
    ...
    if (CurrentRenderer->GetColorFormat() == NDSColorFormat_BGR666_Rev) {
      ColorspaceConvertBuffer6665To8888<false, false>(
          (u32 *)_gfx3d_savestateBuffer, (u32 *)_gfx3d_savestateBuffer,
          GPU_FRAMEBUFFER_NATIVE_WIDTH * GPU_FRAMEBUFFER_NATIVE_HEIGHT);
    }
  }
}
...
void gfx3d_savestate(EMUFILE &os) {
  ...
  // evidently these need to be saved because we don't cache the matrix that
  // would need to be used to properly regenerate them
  for (size_t i = 0; i < 4; i++) {
...
bool gfx3d_loadstate(EMUFILE &is, int size) {
  ...
  // jiggle the lists. and also wipe them. this is clearly not the best thing to
  // be doing.
  listTwiddle = 0;
  polylist = &polylists[0];
  vertList = vertLists;
...
void gfx3d_FinishLoadStateBufferRead() {
  ...
  case RENDERID_NULL:
    memset(CurrentRenderer->GetFramebuffer(), 0,
           GPU_FRAMEBUFFER_NATIVE_WIDTH * GPU_FRAMEBUFFER_NATIVE_HEIGHT *
  ...
  case RENDERID_SOFTRASTERIZER: {
    ...
    if ((w == GPU_FRAMEBUFFER_NATIVE_WIDTH) &&
        (h ==
         GPU_FRAMEBUFFER_NATIVE_HEIGHT)) // Framebuffer is at the native size
    {
      if (CurrentRenderer->GetColorFormat() == NDSColorFormat_BGR666_Rev) {
  ...
  default:
    // Do nothing. Loading the 3D framebuffer is unsupported on this 3D
    // renderer.
    break;
  }
}
...
void ParseReg_DISP3DCNT() {
  const IOREG_DISP3DCNT &DISP3DCNT =
      GPU->GetEngineMain()->GetIORegisterMap().DISP3DCNT;
...
template void gfx3d_glGetMatrix<MATRIXMODE_PROJECTION>(const int index,
                                                       float (&dst)[16]);
template void gfx3d_glGetMatrix<MATRIXMODE_POSITION>(const int index,
                                                     float (&dst)[16]);
template void gfx3d_glGetMatrix<MATRIXMODE_POSITION_VECTOR>(const int index,
                                                            float (&dst)[16]);
template void gfx3d_glGetMatrix<MATRIXMODE_TEXTURE>(const int index,
                                                    float (&dst)[16]);
...
static FORCEINLINE VERT clipPoint(const VERT *inside, const VERT *outside) {
  ...
  const float w_outside =
      (WHICH == -1) ? -outside->coord[3] : outside->coord[3];
  const float t = (coord_inside - w_inside) /
...
#define INTERP(X) ret.X = interpolate(t, inside->X, outside->X)
  ...
  // this seems like a prudent measure to make sure that math doesnt make a
  // point pop back out of the clip volume through interpolation
  if (WHICH == -1)
...
private:
  ...
  FORCEINLINE void clipSegmentVsPlane(const VERT *vert0, const VERT *vert1) {
    ...
    const bool out0 = (WHICH == -1) ? (vert0coord[COORD] < -vert0coord[3])
                                    : (vert0coord[COORD] > vert0coord[3]);
    const bool out1 = (WHICH == -1) ? (vert1coord[COORD] < -vert1coord[3])
                                    : (vert1coord[COORD] > vert1coord[3]);

    // CONSIDER: should we try and clip things behind the eye? does this code
    // even successfully do it? not sure. if(coord==2 && which==1) { 	out0 =
    //vert0coord[2] < 0; 	out1 = vert1coord[2] < 0;
    // }
    ...
    if (!out0 && out1) {
      ...
      scratchClipVerts[numScratchClipVerts] =
          clipPoint<CLIPPERMODE, COORD, WHICH>(vert0, vert1);
    ...
    if (out0 && !out1) {
      ...
      assert((u32)numScratchClipVerts < MAX_SCRATCH_CLIP_VERTS);
      scratchClipVerts[numScratchClipVerts] =
          clipPoint<CLIPPERMODE, COORD, WHICH>(vert1, vert0);
      m_next.clipVert(&scratchClipVerts[numScratchClipVerts++]);
      m_next.clipVert(vert1);
    }
  }
...
// see "Template juggling with Sutherland-Hodgman"
// http://www.codeguru.com/cpp/misc/misc/graphics/article.php/c8965__2/ for the
// idea behind setting things up like this.

// Non-interpolated clippers
static ClipperOutput clipperOut;
typedef ClipperPlane<ClipperMode_Full, 2, 1, ClipperOutput> Stage6;
static Stage6 clipper6(clipperOut); // back plane //TODO - we need to
                                    // parameterize back plane clipping
typedef ClipperPlane<ClipperMode_Full, 2, -1, Stage6> Stage5;
static Stage5 clipper5(clipper6); // front plane
typedef ClipperPlane<ClipperMode_Full, 1, 1, Stage5> Stage4;
static Stage4 clipper4(clipper5); // top plane
typedef ClipperPlane<ClipperMode_Full, 1, -1, Stage4> Stage3;
static Stage3 clipper3(clipper4); // bottom plane
typedef ClipperPlane<ClipperMode_Full, 0, 1, Stage3> Stage2;
static Stage2 clipper2(clipper3); // right plane
typedef ClipperPlane<ClipperMode_Full, 0, -1, Stage2> Stage1;
static Stage1 clipper1(clipper2); // left plane

// Interpolated clippers
static ClipperOutput clipperOuti;
typedef ClipperPlane<ClipperMode_FullColorInterpolate, 2, 1, ClipperOutput>
    Stage6i;
static Stage6i clipper6i(clipperOuti); // back plane //TODO - we need to
                                       // parameterize back plane clipping
typedef ClipperPlane<ClipperMode_FullColorInterpolate, 2, -1, Stage6i> Stage5i;
static Stage5i clipper5i(clipper6i); // front plane
typedef ClipperPlane<ClipperMode_FullColorInterpolate, 1, 1, Stage5i> Stage4i;
static Stage4i clipper4i(clipper5i); // top plane
typedef ClipperPlane<ClipperMode_FullColorInterpolate, 1, -1, Stage4i> Stage3i;
static Stage3i clipper3i(clipper4i); // bottom plane
typedef ClipperPlane<ClipperMode_FullColorInterpolate, 0, 1, Stage3i> Stage2i;
static Stage2i clipper2i(clipper3i); // right plane
typedef ClipperPlane<ClipperMode_FullColorInterpolate, 0, -1, Stage2i> Stage1i;
static Stage1i clipper1i(clipper2i); // left plane

// Determine's clip status only
static ClipperOutput clipperOutd;
typedef ClipperPlane<ClipperMode_DetermineClipOnly, 2, 1, ClipperOutput>
    Stage6d;
static Stage6d clipper6d(clipperOutd); // back plane //TODO - we need to
                                       // parameterize back plane clipping
typedef ClipperPlane<ClipperMode_DetermineClipOnly, 2, -1, Stage6d> Stage5d;
static Stage5d clipper5d(clipper6d); // front plane
typedef ClipperPlane<ClipperMode_DetermineClipOnly, 1, 1, Stage5d> Stage4d;
static Stage4d clipper4d(clipper5d); // top plane
typedef ClipperPlane<ClipperMode_DetermineClipOnly, 1, -1, Stage4d> Stage3d;
static Stage3d clipper3d(clipper4d); // bottom plane
typedef ClipperPlane<ClipperMode_DetermineClipOnly, 0, 1, Stage3d> Stage2d;
static Stage2d clipper2d(clipper3d); // right plane
typedef ClipperPlane<ClipperMode_DetermineClipOnly, 0, -1, Stage2d> Stage1d;
static Stage1d clipper1d(clipper2d); // left plane
...
size_t GFX3D_Clipper::GetPolyCount() const { return this->_clippedPolyCounter; }

void GFX3D_Clipper::Reset() { this->_clippedPolyCounter = 0; }

template <ClipperMode CLIPPERMODE>
bool GFX3D_Clipper::ClipPoly(const u16 polyIndex, const POLY &poly,
                             const VERT **verts) {
  CLIPLOG("==Begin poly==\n");
