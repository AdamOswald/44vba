...
// TODO - endian unsafeness in here... dont like the way these take u32. maybe
// it makes sense and the user is genuinely supposed to present data in units of
// u32
...
void _KEY2::applySeed(u8 PROCNUM) {
  ...
  // PROCNUM?'7':'9', seed0, x); printf("ARM%c: set KEY2 seed1 to %010llX
  // (reverse %010llX)\n", PROCNUM?'7':'9', seed1, y);
}
