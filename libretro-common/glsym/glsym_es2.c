...
RGLSYMGLDRAWARRAYSINSTANCEDBASEINSTANCEEXTPROC
...
RGLSYMGLDRAWRANGEELEMENTSBASEVERTEXEXTPROC
__rglgen_glDrawRangeElementsBaseVertexEXT;
RGLSYMGLDRAWELEMENTSINSTANCEDBASEVERTEXEXTPROC
__rglgen_glDrawElementsInstancedBaseVertexEXT;
RGLSYMGLMULTIDRAWELEMENTSBASEVERTEXEXTPROC
...
RGLSYMGLRENDERBUFFERSTORAGEMULTISAMPLEEXTPROC
__rglgen_glRenderbufferStorageMultisampleEXT;
RGLSYMGLFRAMEBUFFERTEXTURE2DMULTISAMPLEEXTPROC
...
RGLSYMGLGETPROGRAMPIPELINEINFOLOGEXTPROC
